...
function checkDataType(value) {
  ...
  return `Type of value "${value}" is "${type}"`;
...
function getVariableType(variable) {
  ...
  let returnValue =
    typeData === "number"
      ...
      : typeData === "boolean"
      ? "this is a Boolean"
      : "it is a different type of data";
  return returnValue;
...
console.log("factorial(10)", factorial(-3));
...
const memorizedArea = (prevSide = null, prevResult = null) => {
  return (side) => {
    if (prevSide === side) {
...
const squareArea = memorizedArea();
